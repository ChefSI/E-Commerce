# Generated by Django 3.0 on 2023-11-19 11:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdfegh1234567', length=10, max_length=30, prefix='cat', unique=True)),
                ('title', models.CharField(default='Furniture', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdfegh1234567', length=10, max_length=30, prefix='prd', unique=True)),
                ('title', models.CharField(default='Nice Couch', max_length=100)),
                ('image', models.ImageField(default='product.jpg', upload_to='user_directory_Path')),
                ('description', models.TextField(blank='this is the product', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='1,99', max_digits=999999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='2,99', max_digits=999999999999)),
                ('specifications', models.TextField(blank='True', null=True)),
                ('product_status', models.CharField(choices=[('draft', 'Draft'), ('diasbled', 'Disabled'), ('rejected', 'Rejected'), ('in_review', 'In_Review'), ('published', 'Published')], default='in_review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdfegh1234567', length=10, max_length=30, prefix='sel', unique=True)),
                ('title', models.CharField(default='Furni', max_length=100)),
                ('image', models.ImageField(default='seller.jpg', upload_to='user_directory_Path')),
                ('description', models.TextField(blank='Amazing Seller', null=True)),
                ('adress', models.CharField(default='1234 ADRESSS', max_length=100)),
